                  ...
                  {menuItems.map((item, index) => {
                    ...
                    return (
                      <button
                        ...
                        className={`menu-item group relative backdrop-blur-sm rounded-xl ${isMobile ? 'p-2' : 'p-4'} text-center transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 border transform-gpu ${
                          currentView === item.id
