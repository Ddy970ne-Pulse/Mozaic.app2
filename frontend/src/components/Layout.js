  ...
  const renderCurrentView = () => {
    if (user.role === 'employee') {
      ...
      switch (currentView) {
        ...
        case 'my-space':
          return <EmployeeSpaceV2 user={user} onChangeView={setCurrentView} />;
        ...
        case 'analytics-hub':
          return <AnalyticsHub user={user} onChangeView={setCurrentView} />;
              ...
              <div className="flex items-center space-x-3">
                <div className="relative">
                  <button 
                    ...
                    className="notification-button p-2 rounded-xl bg-gradient-to-br from-yellow-400 to-orange-500 text-white hover:from-yellow-500 hover:to-orange-600 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-offset-2 shadow-lg transition-all duration-200" 
                    title="Notifications"
                  >
                  ...
                  {menuItems.map((item, index) => {
                    ...
                    const getItemColors = (id) => {
                      const colors = {
                        ...
                        'analytics-hub': 'from-indigo-500 via-purple-500 to-pink-500',
