...
import { ModuleHeader, StatCard, Button } from './shared/UIComponents';
        ...
        <div className="xl:col-span-2">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <button 
                className="p-2 rounded-lg bg-gradient-to-br from-emerald-500 to-teal-600 text-white hover:from-emerald-600 hover:to-teal-700 focus:outline-none shadow-md transition-all duration-200"
                title="Voir tout"
              >
