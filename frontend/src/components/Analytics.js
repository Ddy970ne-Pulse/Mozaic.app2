        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 shadow-sm border-2 border-blue-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="flex items-end">
              <button
                onClick={() => {
                  // Ici on appliquera le filtre
                  console.log(`Filtrage de ${startDate} à ${endDate}`);
                  // TODO: Charger données via API
                }}
          ...
          <div className="mt-4 flex items-center space-x-2 text-sm text-gray-600">
            <span className="inline-flex items-center">
              💡 <span className="ml-1">Période sélectionnée: </span>
            </span>
            {startDate && endDate ? (
            ...
            <div className="p-6">
              ...
              <div className="mt-6 pt-4 border-t border-gray-200 flex items-center justify-between">
                ...
                <div className="flex space-x-2">
                  <button 
                    className="p-2 rounded-lg bg-gradient-to-br from-green-500 to-emerald-600 text-white hover:from-green-600 hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2 shadow-md transition-all duration-200"
                    title="Exporter CSV"
                  >
                  ...
                  <button 
                    className="p-2 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-600 text-white hover:from-blue-600 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 shadow-md transition-all duration-200"
            ...
            <div className="p-6">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <button 
                    className="p-2 rounded-lg bg-gradient-to-br from-gray-500 to-slate-600 text-white hover:from-gray-600 hover:to-slate-700 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 shadow-md transition-all duration-200"
