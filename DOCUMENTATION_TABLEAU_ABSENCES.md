...
**Exemple** :
```bash
curl -X POST "https://absence-tracker-21.preview.emergentagent.com/api/analytics/generate-absence-report?year=2025&month=10" \
...
response = requests.post(
    "https://absence-tracker-21.preview.emergentagent.com/api/analytics/generate-absence-report",
