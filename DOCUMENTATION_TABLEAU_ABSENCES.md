...
**Exemple** :
```bash
curl -X POST "https://mozaik-hr-2.preview.emergentagent.com/api/analytics/generate-absence-report?year=2025&month=10" \
...
response = requests.post(
    "https://mozaik-hr-2.preview.emergentagent.com/api/analytics/generate-absence-report",
