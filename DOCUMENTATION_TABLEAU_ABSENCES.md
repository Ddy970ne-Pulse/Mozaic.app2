...
**Exemple** :
```bash
curl -X POST "https://saas-hr-hub.preview.emergentagent.com/api/analytics/generate-absence-report?year=2025&month=10" \
...
response = requests.post(
    "https://saas-hr-hub.preview.emergentagent.com/api/analytics/generate-absence-report",
