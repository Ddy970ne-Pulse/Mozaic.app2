...
```python
# .env
CORS_ORIGINS="https://oncall-planner-2.preview.emergentagent.com,http://localhost:3000"
...
✅ CORS origins properly logged: `['https://oncall-planner-2.preview.emergentagent.com', 'http://localhost:3000']`
