...
```python
# .env
CORS_ORIGINS="https://hr-multi-saas.preview.emergentagent.com,http://localhost:3000"
...
✅ CORS origins properly logged: `['https://hr-multi-saas.preview.emergentagent.com', 'http://localhost:3000']`
